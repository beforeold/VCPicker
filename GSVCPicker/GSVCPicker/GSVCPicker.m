...
+ (void)activateWhenDebug {
    [self activateWithClassPrefixesWhenDebug:nil except:nil needTitle:NO];
}

+ (void)activateWithClassPrefixesWhenDebug:(NSArray <NSString *> *)prefixes {
    [self activateWithClassPrefixesWhenDebug:prefixes except:nil needTitle:NO];
}

+ (void)activateWithClassPrefixesWhenDebug:(NSArray *)prefixes except:(NSArray *)exceptArray {
    [self activateWithClassPrefixesWhenDebug:prefixes except:exceptArray needTitle:NO];
}
